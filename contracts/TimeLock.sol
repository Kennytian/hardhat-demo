...
contract TimeLock {
    ...
    error TimestampExpiredError(uint256 blockTimestamp, uint256 expriedAt);
    error TxFailedError();
    ...
    function cancel(bytes _txId) external onlyOwner {
        if (!queued[_txId]) {
...
contract TestTimeLock {
    ...
    function test() external {
        require(msg.sender == timeLock, "owner != timeLock");
